...
root_url = 'http://pretorched-x.csail.mit.edu/models/detection/facenet'
model_urls = {
    'pnet': os.path.join(root_url, 'pnet-a2a71925.pth'),
    'rnet': os.path.join(root_url, 'rnet-bbb937de.pth'),
    'onet': os.path.join(root_url, 'onet-165bfbe4.pth'),
}
...
class PNet(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            self.load_state_dict(model_zoo.load_url(model_urls['pnet']))
...
class RNet(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            self.load_state_dict(model_zoo.load_url(model_urls['rnet']))

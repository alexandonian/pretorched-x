...
DATASET_ROOT = '/data/vision/oliva/scratch/datasets'
...
root_dirs = {
    'ImageNet': os.path.join(DATASET_ROOT, 'ImageNet'),
    'Places365': os.path.join(DATASET_ROOT, 'Places365'),
}
...
def parse_args():
    ...
    if args.data is not None:
        args.dataset = os.path.basename(args.data.rstrip('/'))
    elif args.dataset in root_dirs:
        args.data = root_dirs[args.dataset]
    else:

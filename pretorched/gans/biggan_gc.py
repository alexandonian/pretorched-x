...
from pretorched.layers import SynchronizedBatchNorm2d as BatchNorm2d
...
class ConditionalBatchNorm2d(nn.Module):
    def __init__(self, num_features, num_classes):
        ...
        self.bn = BatchNorm2d(num_features, affine=False, eps=1e-4, momentum=0.1)
...
class Generator(nn.Module):
    def __init__(self, code_dim=140, n_class=1000, chn=96, debug=False):
        ...
        self.ScaledCrossReplicaBN = BatchNorm2d(1 * chn, eps=1e-4, momentum=0.1)
    ...
    def forward(self, input, class_id):
        ...
        out = checkpoint(self.ScaledCrossReplicaBN, out)
        out = F.relu(out)
...
class Generator512(nn.Module):
    def __init__(self, code_dim=128, n_class=1000, chn=96, debug=False):
        ...
        self.ScaledCrossReplicaBN = BatchNorm2d(1 * chn, momentum=0.9999)
        self.colorize = SpectralNorm(nn.Conv2d(1 * chn, 3, [3, 3], padding=1))
...
def biggan256():
    s = '/data/vision/oliva/scratch/aandonia/pretorched-x/pretorched/gans/biggan-256.pth'
    G = Generator()
...
def biggan512():
    s = '/data/vision/oliva/scratch/aandonia/pretorched-x/pretorched/gans/biggan-512.pth'
    G = Generator512()
    G.load_state_dict(torch.load(s))
    return G
